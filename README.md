...
- [X] Resolve DNS Host Name
- [X] Establish TCP Connection
- [X] Start TLS Session when using `https` scheme
- [ ] Parse HTTP

## Roadmap

List of parameters and flags already implemented or planned to be implemented in the future:

- [X] Connection Timeout (`--connect-timeout <value: f32>`)
- [X] Data (`--data <value: String>`)
- [X] GET Request with Data (`-G`, `--get`)
- [X] HEAD Request (`-I`, `--head`)
- [X] Verbosity (`-q`, `-v`, `-vv`, `-vvv`, `-vvvv`)
- [ ] Custom Public Key Infrastructure (`--cacert`, `--capath`, `cert`, `cert_status`, `cert_type`, `--ciphers`)
- [ ] Cookie (`-b <data|filename>`, `--cookie <data|filename>`)
- [ ] Cookie Jar (`-c <filename>`, `--cookie-jar <filename>`)
- [ ] Form (`-F <value: String>`, `--form <value: String>`)
- [ ] Form String (`--form-string <value: String>`)
- [ ] Header (`-H <key:value>`, `--header <key:value>`)
- [ ] Response Headers (`-i`, `--include`)
- [ ] Output File (`-o <file>`, `--output <file>`)
- [ ] User (`-u <user:password>`, `--user <user:password>`)
- [ ] User Agent (`-A <value>`, `--user-agent <value: String>`)
...
Options:
  ...
  -E, --cert <certificate[:password]>        Client certificate file and password
      ...
      --connect-timeout <fractional second>  Maximum time allowed for connection
  -b, --cookie <data|filename>               Send cookies from string/file
  -c, --cookie-jar <filename>                Write cookies to <filename> after operation
  -d, --data <data>                          HTTP POST data
  -F, --form <name=string>                   Specify multipart MIME data
...
It is unrealistic to catch up with that many features offered by `curl`, nonetheless it is still great to see all its options in comparison.
